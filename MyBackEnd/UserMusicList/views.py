...
class AddtoList(APIView):
    def post(self , request):
        ...
        get_or_create=MusicDB.objects.get_or_create(videoId=getVideoId,channel_id=getVideoChannelId,channel_name=getChannelTitle,videoThumbnails=getVideoThumbnail,videoTitle=getVideoTitle)
